...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LEFT,    KC_RGHT,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,    RGB_MOD,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
     ...
     */
    [2] = LAYOUT(
        KC_ESC,   KC_F11,  KC_F12,  _______, _______, _______,                      _______, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_BSPC,
        _______,  _______, _______, _______, _______, _______, _______,    _______,  _______, KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_DEL,
        _______,  _______, _______, _______, _______, _______, _______,    _______,  _______, KC_P1,   KC_P2,   KC_P3,   KC_PMNS, KC_ENT,
        _______,  _______, _______, _______, _______, _______, KC_MUTE,    _______,  _______, KC_P0,   KC_P0,   KC_PDOT, KC_PPLS, KC_ENT,
